...
本场不把获得感压缩成“听懂一个技术概念”。每位参与者离场前应得到：

1. **作品**：本人 workspace 内的唯一安全 sample；具备绿灯条件时继续完成真实录音 Loop。
2. **连接**：认识两位能继续互助的伙伴，并明确活动后的连接动作。
3. **行动**：把一项未来 72 小时内可检查的动作发到活动群。

讲师必须同时守住理解、参与、连接、互助和行动五层体验。技术实操是主轴，但不能用单向讲授挤掉
自我介绍、分组协作、成果反馈和离场承诺。
